                ...
                <form className='LessonMakingForm'>
                    <div className='LessonProfileWrapper'>
                        ...
                        <S.ProfileRegistration>
                            ...
                            <S.ProfileInputWrapper>
                                <input  type='text' placeholder='전문가 이름을 등록하세요' onChange={inputName}/>
                                <input  type='text' placeholder='레슨 이름을 등록 하세요'onChange={inputLessonName}/>
                                <input  type='text' onChange={inputCallTime} placeholder='연락 가능시간'/>
                            </S.ProfileInputWrapper>   
                        </S.ProfileRegistration>
                    </div>
                    ...
                    <S.CategoryRegistration>
                        ...
                        <S.LessonCategoryWrapper>
                            <button type='button' onClick={changeToactive} value="음악">음악</button>
                            <button type='button' onClick={changeToactive} value="연기" className='active'>연기</button>
                            <button type='button' onClick={changeToactive} value="마술">마술</button> 
                        </S.LessonCategoryWrapper>
                    </S.CategoryRegistration>
                    ...
                    <S.LocationRegistation>
                        ...
                        <S.LessonLocationWrapper>
                            <S.LessonLocation  onChange={inputAddress} placeholder='주소를 입력해 주세요 ex) 서울시 강남구'/>
