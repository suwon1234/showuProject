        ...
        <S.LessonDetailsWrapper>
            ...
            <S.LessonDetailContentsWrapper>
                ...
                <div className='InstructorPortfolio'>
                    <h3 className='Title'>포트폴리오 890x200</h3>
                    <div className='PortfolioWrapper'>
                        <div className='Portfolio'>
                            <p className='PortfolioTitle'>메채 연기레슨</p>
                            <p className='LessonType'>연기 레슨</p>
                        </div>
                        <div className='Portfolio'>
                            <p className='PortfolioTitle'>메채 연기레슨</p>
                            <p className='LessonType'>연기 레슨</p>
                ...
                <div className='InstructorMedia'>
                    <h3 className='Title'>사진 및 동영상870X330</h3>
                ...
                <div className='StudentReview'>
                    ...
                    <p className='ReviewScoreWrapper'>
                        <div className='ReviewScore'>5.0</div>
                        <div className='ReviewScoreIconWrapper'>
                            <p className='ReviewScoreIcon'>
                                <span></span>
                                <span></span>
                                <span></span>
                                <span></span>
                    ...
                    <div className='ReviewWrapper'>
                        <p className='ReviewerName'>김**</p>
                        <p className='LessonTypeAndScore'>
                            <span className='LessonType'>
                                연기 레슨
                            </span>
                            <span className='LessonScoreWrapper'>
                                <span className='LessonScoreIcon'>

                                </span>
                                <span className='LessonScore'>
                                    5.0
                                </span>
                            </span>
                            <div className='UpdateAndDeleteButtonWrapper'>
                                <button className='UpdateButton'>수정</button>
                                <button className='DeleteBUtton'>삭제</button>
                            </div>
                        </p>
                        <div className='LessonReviewWrapper'>
                            <div className='LessonReview'>                              
                                연기에 대해 하나도모르는 채로 가서 걱정했었는데 기초부터 차근차근 수업해주셔서 잘 배울 수 있었어요^^ 기
                                초적인 것이 어느정도 되고 디테일 한 부분까지 알려주셔서 좋있습니다 ㅎㅎ
                            </div>
                            <span className='MoreReview'>
                                더보기
                            </span>
                        </div>
                        <p className='ReviewWriteDate'>2023. 10. 06</p>
                    </div>    
                    <S.MoreDetails>
                ...
                <div className='LessonQNAWrapper'>
                    <h3 className='Title'>질문/답변</h3>
                    <div className='LessonQNA'>
                        <p className='LessonQuestion'>
                            Q. 서비스가 시작되기 전 어떤 절차고 진행하나요?
                        </p>
                        <div className='LessonAnswer'>
